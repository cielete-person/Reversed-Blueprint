...
| 항목 ID | 항목명 | 유형 | 해야 할 일 |
|---|---|---|---|
| P3-3 | 개인정보보호법 적정성 판단 | `[인터뷰]` | 법무/개인정보보호 담당자가 수집 동의, 보관 기간, 파기 절차를 검토 |
| P3-4 | 보안 취약점 대응 우선순위 | `[확정]` | 보안센터가 Gap 항목별 대응 우선순위를 결정 |
| P2-1 | Stakeholder 리뷰 (보안) | `[확정]` | 보안센터가 보안 현황 산출물의 위험 항목, 대응 우선순위를 리뷰 |
